...
{
    protected static final Transfer TRANSFER_1 = new Transfer(3001, 2, 2, 2001, 2002, new BigDecimal("500"));
    protected static final Transfer TRANSFER_2 = new Transfer(3002, 2, 2, 2001, 2002, new BigDecimal("500"));
    protected static final Transfer TRANSFER_3 = new Transfer(3003, 1, 2, 2002, 2001, new BigDecimal("500"));
    ...
    public void addTransfer_CreatesATransferInTransferTable()
    {
        ...
        // act
        Integer actualId = sut.addTransfer(TRANSFER_1);
        // assert
